...
export const GALAXIES: GalaxyDef[] = [
  ...
  },
  {
    ...
    type: 'Giant elliptical (E+0-1 pec)',
    facts: {
  ...
  },
  {
    ...
    type: 'Spiral (SA(s)bc pec), interacting',
    facts: {
  ...
  },
  {
    ...
    type: 'Peculiar lenticular/elliptical',
    facts: {
  ...
  },
  {
    ...
    type: 'Giant barred spiral (SB(s)b)',
    facts: {
  ...
  },
  {
    ...
    type: 'Dwarf lenticular, interacting',
    facts: {
